...
import MarketCollectiondata from '@/data/MarketCollection'
import avtar from "@/public/Avatar.png"
import MarketPlaceShimmer from './MarketPlaceShimmer'

const NftMarketCollectionCard = () => {
    const [isskeleton, setisskeleton] = useState(true)
    const [data, setdata] = useState(MarketCollectiondata)
...
export default NftMarketCollectionCard
