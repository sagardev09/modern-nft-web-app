            ...
            <div className='flex gap-8'>
                ...
                <div className='flex-1 p-12 flex flex-col gap-4 justify-center items-start'>
                    ...
                    <div className='w-full relative mt-8'>
                        ...
                        <input type="text" className='py-4 px-8 h-[46px] w-[360px] rounded-2xl text-sm font-normal focus:outline-none bg-gray-500 bg-opacity-50 text-white' placeholder='Username' />
                    </div>
                    <div className='w-full relative'>
                        <Image src={"/mail.svg"} alt='user' width={16} height={16} className='absolute left-[10px] cursor-pointer top-[14px]' />
                        <input type="text" className='py-4 px-8 h-[46px] w-[360px] rounded-2xl text-sm font-normal focus:outline-none text-white  bg-gray-500 bg-opacity-50' placeholder='Email Address' />
                    </div>
                    <div className='w-full relative'>
                        <Image src={"/password.svg"} alt='user' width={16} height={16} className='absolute left-[10px] cursor-pointer top-[14px]' />
                        <input type="text" className='py-4 px-8 h-[46px] w-[360px] rounded-2xl text-sm font-normal focus:outline-none text-white  bg-gray-500 bg-opacity-50' placeholder='Password' />
                    </div>
                    <div className='w-full relative'>
                        <Image src={"/password.svg"} alt='user' width={16} height={16} className='absolute left-[10px] cursor-pointer top-[14px]' />
                        <input type="text" className='py-4 px-8 h-[46px] w-[360px] rounded-2xl text-sm font-normal focus:outline-none text-white  bg-gray-500 bg-opacity-50' placeholder='Confirm Password' />
                    </div>
